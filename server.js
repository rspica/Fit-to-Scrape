...
db.once('open', function() {
    console.log(chalk.bold.bgYellowBright(" ** Mongoose connection success ** "));
});
...
//             result.title = createTitle(urlEndPoint);
...
//             //console.log(chalk.bold.gray('recipe image: '),chalk.redbright(result.image)+'\n\n')
...
// Routes
//================================================
 var router = require('./controllers/scrape_control.js');
 app.use('/', router);
